...
const Home = () => {
    return(
        ...
        <div className={style.eventsDiv}>
            ...
            <p  className={style.pEventsDiv}>Sábado <br/> 18.11.2023 <br/><br/>17:00 h <br/><br/>Iglesia So-Mang <br/>(Morón 3744, Flores, CABA)</p>
        ...
        <div className={style.eventsDiv}>
            ...
            <p  className={style.pEventsDiv}>Sábado <br/> 18.11.2023 <br/><br/>19:00 h <br/><br/>Lowlands <br/>(Blanco Encalada 1201,<br/> Belgrano, CABA)</p>
